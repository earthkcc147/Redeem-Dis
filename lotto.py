...
class SettingsView(discord.ui.View):
    @discord.ui.button(label="ตั้งค่าทั่วไป", style=discord.ButtonStyle.green)  # แก้ไขที่นี่
    ...
    @discord.ui.button(label="ตั้งค่ารางวัล", style=discord.ButtonStyle.blurple)  # แก้ไขที่นี่
